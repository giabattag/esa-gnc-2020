...
\begin{abstract}
    ...
    First, a preliminary assessment of the algorithm performance on hardware was derisked in both the image processing and the navigation filter, which showed consistent performance 
